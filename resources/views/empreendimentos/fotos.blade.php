...
<head>
  ...
  {{-- Alpine.js para o modal de zoom (caso ainda não use globalmente) --}}
  ...
  <div
    ...
    x-init="
      document.addEventListener('keydown', (e) => {
        if (showModal && e.key === 'Escape') close();
        if (showModal && e.key === 'ArrowRight') next();
        if (showModal && e.key === 'ArrowLeft') prev();
      });
    "
  >
